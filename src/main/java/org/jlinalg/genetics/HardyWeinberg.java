...
public final class HardyWeinberg {
    private HardyWeinberg() { }

    public static Result calculate(double[] dosage, int[] groups, int selectedGroup) {
        int homRef = 0;
        int heterozygous = 0;
        int homAlt = 0;
    ...
    private static double exact(int firstHomozygotes, int heterozygotes,
        ...
        int midpoint = (int) ((long) rareCopies * (2L * genotypes - rareCopies)
            / (2L * genotypes));
    ...
    public record Result(double pValue, int samples, String method) { }
}
