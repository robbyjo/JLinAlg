...
Version 0.3.5 adds executable mediation, SuSiE, and colocalization workflows,
strengthens association preflight and filter validation, and corrects pedigree
...
Version 0.3.5 uses JDistlib 0.10.2; see the
...
- Prebuilt v0.3.5 artifacts and checksums are on the
  [GitHub release page](https://github.com/robbyjo/JLinAlg/releases/tag/v0.3.5).
  Use `jlinalg-0.3.5.jar` for the self-contained CLI; the separate
  `JLinAlg-0.3.5-library.jar` is the thin library.
- A JDK 17 or newer.
