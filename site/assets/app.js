    ...
    this.innerHTML = `
      <footer class="site-footer">
        <div class="container">
          ...
          <div class="footer-bottom"><span>© <span data-year></span> JLinAlg contributors · GPL-2.0-or-later</span><span>JLinAlg v0.3.2 · Java 17+ · Source: JDistlib 0.10.2 · FP64</span></div>
        </div>
      </footer>`;
